...
```{r}
base_burrito <- 6.50
chicken_burrito <- base_burrito + 3
steak_burrito <- base_burrito - 3.5
main_ingredient <- c("veggie")
chicken <- c("chicken")
steak<- c("steak")

if(main_ingredient == "veggi"){
  print(paste("Price of", base_burrito))
} else if (chicken == "chicke"){
  print(paste("Price of chicken burrito", chicken_burrito))
} else if (steak == "steak"){
  print(paste("Price of steak burrito", steak_burrito))
}
```
